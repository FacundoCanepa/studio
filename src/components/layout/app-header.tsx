        ...
        <div className="flex items-center justify-end space-x-4">
          <div className="hidden md:flex items-center space-x-2">
            ...
            <a href="#" className="social-container pinterest" aria-label="Pinterest">
                <svg className="social-svg" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                ...
                <nav className="flex flex-col space-y-4 p-4">
                 ...
                 <div className="mt-auto p-4 border-t">
                    <div className="flex items-center justify-center space-x-4">
                        ...
                        <a href="#" className="social-container facebook" aria-label="Facebook"><Facebook className="h-6 w-6 social-svg"/></a>
                    </div>
                </div>
              </div>
            </SheetContent>
