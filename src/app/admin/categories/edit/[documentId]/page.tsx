...
import { getCategoryHasDescriptionField, getCategory } from '@/lib/strapi-client';
...
export default async function EditCategoryPage({ params }: Props) {
  const category = await getCategory(params.documentId);
  const showDescriptionField = await getCategoryHasDescriptionField();
  ...
  return (
    <div className="space-y-8">
      ...
      <CategoryForm category={category} showDescriptionField={showDescriptionField} />
    </div>
  );
}
