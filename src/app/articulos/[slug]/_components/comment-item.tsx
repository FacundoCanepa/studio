          ...
          {(canEdit || canDelete) && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {canEdit && <DropdownMenuItem onClick={() => setIsEditing(true)}>Editar</DropdownMenuItem>}
                {canDelete && (
                    <DeleteConfirm onConfirm={handleDelete} title="¿Eliminar comentario?" description="Esta acción es permanente.">
